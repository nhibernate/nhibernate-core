...
* [Read-only entities](readonly.md#read-only-entities)
   * [Making persistent entities read-only](readonly.md#making-persistent-entities-read-only)
      * [Entities of immutable classes](readonly.md#entities-of-immutable-classes)
      * [Loading persistent entities as read-only](readonly.md#loading-persistent-entities-as-read-only)
      * [Loading read-only entities from an HQL query/criteria](readonly.md#loading-read-only-entities-from-an-hql-querycriteria)
      * [Making a persistent entity read-only](readonly.md#making-a-persistent-entity-read-only)
   * [Read-only affect on property type](readonly.md#read-only-affect-on-property-type)
      * [Simple properties](readonly.md#simple-properties)
      * [Unidirectional associations](readonly.md#unidirectional-associations)
         * [Unidirectional one-to-one and many-to-one](readonly.md#unidirectional-one-to-one-and-many-to-one)
         * [Unidirectional one-to-many and many-to-many](readonly.md#unidirectional-one-to-many-and-many-to-many)
      * [Bidirectional associations](readonly.md#bidirectional-associations)
         * [Bidirectional one-to-one](readonly.md#bidirectional-one-to-one)
         * [Bidirectional one-to-many/many-to-one](readonly.md#bidirectional-one-to-manymany-to-one)
         * [Bidirectional many-to-many](readonly.md#bidirectional-many-to-many)
...
* [Linq Queries](querylinq.md#linq-queries)
   * [Structure of a Query](querylinq.md#structure-of-a-query)
   * [Parameter types](querylinq.md#parameter-types)
   * [Supported methods and members](querylinq.md#supported-methods-and-members)
      * [Common methods](querylinq.md#common-methods)
      * [DateTime and DateTimeOffset](querylinq.md#datetime-and-datetimeoffset)
      * [ICollection, non generic and generic](querylinq.md#icollection-non-generic-and-generic)
      * [IDictionary, non generic and generic](querylinq.md#idictionary-non-generic-and-generic)
      * [Mathematical functions](querylinq.md#mathematical-functions)
      * [Nullables](querylinq.md#nullables)
      * [Strings](querylinq.md#strings)
   * [Future results](querylinq.md#future-results)
   * [Fetching associations](querylinq.md#fetching-associations)
   * [Modifying entities inside the database](querylinq.md#modifying-entities-inside-the-database)
      * [Inserting new entities](querylinq.md#inserting-new-entities)
      * [Updating entities](querylinq.md#updating-entities)
      * [Deleting entities](querylinq.md#deleting-entities)
   * [Query cache](querylinq.md#query-cache)
   * [Extending the Linq to NHibernate provider](querylinq.md#extending-the-linq-to-nhibernate-provider)
      * [Adding SQL functions](querylinq.md#adding-sql-functions)
      * [Adding a custom generator](querylinq.md#adding-a-custom-generator)
* [Native SQL](querysql.md#native-sql)
   * [Using an ISQLQuery](querysql.md#using-an-isqlquery)
      * [Scalar queries](querysql.md#scalar-queries)
      * [Entity queries](querysql.md#entity-queries)
      * [Handling associations and collections](querysql.md#handling-associations-and-collections)
      * [Returning multiple entities](querysql.md#returning-multiple-entities)
         * [Alias and property references](querysql.md#alias-and-property-references)
      * [Returning non-managed entities](querysql.md#returning-non-managed-entities)
      * [Handling inheritance](querysql.md#handling-inheritance)
      * [Parameters](querysql.md#parameters)
   * [Named SQL queries](querysql.md#named-sql-queries)
      * [Using return-property to explicitly specify column/alias names](querysql.md#using-return-property-to-explicitly-specify-columnalias-names)
      * [Using stored procedures for querying](querysql.md#using-stored-procedures-for-querying)
         * [Rules/limitations for using stored procedures](querysql.md#ruleslimitations-for-using-stored-procedures)
   * [Custom SQL for create, update and delete](querysql.md#custom-sql-for-create-update-and-delete)
   * [Custom SQL for loading](querysql.md#custom-sql-for-loading)
