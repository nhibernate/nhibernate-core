...
if( element1 == null )
	...
	if( typeOfElement2 == typeof(CreateAttribute) )
				{
					if( element1 is DropAttribute || element1 is DefinitionAttribute || element1 is DialectScopeAttribute || typeOfElement2 == null )
						return true;
				}
	if( typeOfElement2 == typeof(DropAttribute) )
				{
					if( element1 is DefinitionAttribute || element1 is DialectScopeAttribute || typeOfElement2 == null )
						return true;
				}
	if( typeOfElement2 == typeof(DefinitionAttribute) )
				{
	...
	if( typeOfElement2 == typeof(ArrayAttribute) )
				{
					if( element1 is PrimitiveArrayAttribute || element1 is JoinAttribute || element1 is SubclassAttribute || element1 is JoinedSubclassAttribute || element1 is LoaderAttribute || element1 is SqlInsertAttribute || element1 is SqlUpdateAttribute || element1 is SqlDeleteAttribute || element1 is FilterAttribute || typeOfElement2 == null )
						return true;
				}
	if( typeOfElement2 == typeof(PrimitiveArrayAttribute) )
				{
					if( element1 is JoinAttribute || element1 is SubclassAttribute || element1 is JoinedSubclassAttribute || element1 is LoaderAttribute || element1 is SqlInsertAttribute || element1 is SqlUpdateAttribute || element1 is SqlDeleteAttribute || element1 is FilterAttribute || typeOfElement2 == null )
						return true;
				}
	...
	if( typeOfElement2 == typeof(BagAttribute) )
				{
					if( element1 is IdBagAttribute || element1 is ArrayAttribute || element1 is PrimitiveArrayAttribute || element1 is JoinAttribute || element1 is SubclassAttribute || element1 is LoaderAttribute || element1 is SqlInsertAttribute || element1 is SqlUpdateAttribute || element1 is SqlDeleteAttribute || typeOfElement2 == null )
						return true;
				}
	if( typeOfElement2 == typeof(IdBagAttribute) )
				{
					if( element1 is ArrayAttribute || element1 is PrimitiveArrayAttribute || element1 is JoinAttribute || element1 is SubclassAttribute || element1 is LoaderAttribute || element1 is SqlInsertAttribute || element1 is SqlUpdateAttribute || element1 is SqlDeleteAttribute || typeOfElement2 == null )
						return true;
				}
	if( typeOfElement2 == typeof(ArrayAttribute) )
				{
					if( element1 is PrimitiveArrayAttribute || element1 is JoinAttribute || element1 is SubclassAttribute || element1 is LoaderAttribute || element1 is SqlInsertAttribute || element1 is SqlUpdateAttribute || element1 is SqlDeleteAttribute || typeOfElement2 == null )
						return true;
				}
	if( typeOfElement2 == typeof(PrimitiveArrayAttribute) )
				{
					if( element1 is JoinAttribute || element1 is SubclassAttribute || element1 is LoaderAttribute || element1 is SqlInsertAttribute || element1 is SqlUpdateAttribute || element1 is SqlDeleteAttribute || typeOfElement2 == null )
						return true;
				}
	if( typeOfElement2 == typeof(JoinAttribute) )
				{
	...
	if( typeOfElement2 == typeof(SqlDeleteAttribute) )
			...
			if( baseAttrib is JoinAttribute )
			{
	if( typeOfElement2 == typeof(KeyAttribute) )
				{
					if( element1 is PropertyAttribute || element1 is ManyToOneAttribute || typeOfElement2 == null )
						return true;
				}
	if( typeOfElement2 == typeof(PropertyAttribute) )
				{
					if( element1 is ManyToOneAttribute || typeOfElement2 == null )
						return true;
				}
	if( typeOfElement2 == typeof(ManyToOneAttribute) )
				{
...
for(; i<memberAttribs.Count; i++)
			{
				BaseAttribute memberAttrib = memberAttribs[i] as BaseAttribute;
				if( IsNextElement(memberAttrib, parentAttribute, attribute.GetType())
					|| IsNextElement(memberAttrib, attribute, typeof(DefinitionAttribute)) )
					break; // next attributes are 'elements' of the same level OR for 'sub-elements'
				else
				{
					if( memberAttrib is DatabaseObjectAttribute )
						break; // Following attributes are for this DatabaseObject
					if( memberAttrib is DefinitionAttribute )
						WriteDefinition(writer, member, memberAttrib as DefinitionAttribute, attribute, mappedClass);
				}
			}
WriteUserDefinedContent(writer, member, typeof(DefinitionAttribute), attribute);
...
WriteUserDefinedContent(writer, member, typeof(DialectScopeAttribute), attribute);
		...
		public virtual void WriteImport(System.Xml.XmlWriter writer, System.Type type)
		{
object[] attributes = type.GetCustomAttributes(typeof(ImportAttribute), false);
			if(attributes.Length == 0)
				return;
			ImportAttribute attribute = attributes[0] as ImportAttribute;

writer.WriteStartElement( "import" );
			// Attribute: <class>
writer.WriteAttributeString("class", attribute.Class==null ? DefaultHelper.Get_Import_Class_DefaultValue(type) : GetAttributeValue(attribute.Class, type));
			// Attribute: <rename>
if(attribute.Rename != null)
writer.WriteAttributeString("rename", GetAttributeValue(attribute.Rename, type));
		...
		public virtual void WriteNestedImportTypes(System.Xml.XmlWriter writer, System.Type type)
		{
foreach(System.Type nestedType in type.GetNestedTypes(System.Reflection.BindingFlags.Instance | System.Reflection.BindingFlags.Public | System.Reflection.BindingFlags.NonPublic))
			{
				if(nestedType.GetCustomAttributes(typeof(ClassAttribute), false).Length != 0)
					continue;
				if(nestedType.GetCustomAttributes(typeof(ImportAttribute), false).Length == 0)
					WriteNestedImportTypes(writer, nestedType); // Not mapped (try its nested types)
				else // Mapped
					WriteImport(writer, nestedType);
			}
		}
