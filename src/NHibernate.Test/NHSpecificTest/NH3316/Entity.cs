...
namespace NHibernate.Test.NHSpecificTest.NH3316
{
    class Entity
    {
        private ICollection<ChildComponent> _Children;
        public Entity()
        {
            _Children = new HashSet<ChildComponent>();
        }

        public virtual Guid Id { get; set; }

        public virtual IEnumerable<ChildComponent> Children { get { return _Children; } }

        public virtual void AddChild(int value)
        {
            _Children.Add(new ChildComponent(this, value));
        }
