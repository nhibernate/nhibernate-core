...
namespace NHibernate.Test.NHSpecificTest.NH3253
{
    ...
    /// <code>
    /// ...
    /// 82        EntityKey key = new EntityKey(id, persister, source.EntityMode);
    /// 83        source.PersistenceContext.RemoveEntity(key);
    /// 84        if (persister.HasCollections)
    /// ...
    /// </code>
    ...
    /// <code>
    /// ...
    /// 304		internal object GetRowFromResultSet(IDataReader resultSet, ISessionImplementor session,
    /// 305		                                    QueryParameters queryParameters, LockMode[] lockModeArray,
    /// 306		                                    EntityKey optionalObjectKey, IList hydratedObjects, EntityKey[] keys,
    /// 307		                                    bool returnProxies)
    /// 308		{
    /// 309			ILoadable[] persisters = EntityPersisters;
    /// ...
    /// </code>
