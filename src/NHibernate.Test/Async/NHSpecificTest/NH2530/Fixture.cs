...
namespace NHibernate.Test.NHSpecificTest.NH2530
{
	...
	public class FixtureAsync: BugTestCase
	{
		...
		[Test]
		public void WhenTryToGetHighThenExceptionShouldContainWhereClauseAsync()
		{
			using (var session = OpenSession())
			using (var tx = session.BeginTransaction())
			{
				var customer = new Customer { Name = "Mengano" };
				Assert.That(() => session.PersistAsync(customer), Throws.Exception.Message.Contains("Entity = 'Customer'"));
			}
		}
	}
}
