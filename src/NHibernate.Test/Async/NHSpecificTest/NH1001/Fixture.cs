...
namespace NHibernate.Test.NHSpecificTest.NH1001
{
	...
	public class FixtureAsync : BugTestCase
	{
		...
		[Test]
		public async Task DepartmentsAreNotNullAsync()
		{
		...
		[Test]
		public async Task Department1IsNullAsync()
		{
		...
		[Test]
		public async Task Department2IsNullAsync()
		{
		...
		[Test]
		public async Task Department3IsNullAsync()
		{
		...
		[Test]
		public void Department3IsNotFoundAsync()
		{
			var statistics = Sfi.Statistics;
			statistics.Clear();
		...
		[Test]
		public async Task Department5IsNullAsync()
		{
		...
		[Test]
		public async Task PhoneIsEmptyAsync()
		{
			ExecuteStatement($"UPDATE EMPLOYEES SET DEPARTMENT_ID_1 = 11, DEPARTMENT_ID_2 = 12, DEPARTMENT_ID_3 = 13, DEPARTMENT_ID_4 = 24, DEPARTMENT_ID_5 = 25, ADDRESS_ID = 31 WHERE EMPLOYEE_ID = {employeeId}");
		...
		public async Task Department2And4AreNull_QueryOverAsync()
		{
			...
			using (var session = OpenSession())
			{
				var employee = await (session.QueryOver<Employee>()
		...
		[Test]
		public async Task Department2And4AreNull_LinqAsync()
		{
			ExecuteStatement($"UPDATE EMPLOYEES SET DEPARTMENT_ID_1 = 11, DEPARTMENT_ID_2 = 99999, DEPARTMENT_ID_3 = 13, DEPARTMENT_ID_4 = 99999, DEPARTMENT_ID_5 = 25, ADDRESS_ID = 31 WHERE EMPLOYEE_ID = {employeeId}");
			...
			using (var session = OpenSession())
			{
				...
				var employee = await (session.Query<Employee>().Fetch(x => x.Department2).Fetch(x => x.Department4).SingleAsync());
		...
		[Test]
		public async Task Department2IsNullSkipPhones_QueryOverAsync()
		{
			ExecuteStatement($"UPDATE EMPLOYEES SET DEPARTMENT_ID_1 = 11, DEPARTMENT_ID_2 = 99999, DEPARTMENT_ID_3 = 13, DEPARTMENT_ID_4 = 24, DEPARTMENT_ID_5 = 25, ADDRESS_ID = 31 WHERE EMPLOYEE_ID = {employeeId}");
