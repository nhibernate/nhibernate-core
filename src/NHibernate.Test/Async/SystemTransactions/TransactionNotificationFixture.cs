...
namespace NHibernate.Test.SystemTransactions
{
	...
	public class TransactionNotificationFixtureAsync : TestCase
	{
		...
		[Test]
		public async Task ShouldNotifyAfterDistributedTransactionAsync([Values(false, true)] bool doCommit)
		{
		...
		[Description("NH2128")]
		[Test]
		public async Task ShouldNotifyAfterDistributedTransactionWithOwnConnectionAsync([Values(false, true)] bool doCommit)
		{
			// Note: For distributed transaction, calling Close() on the session isn't
			// supported, so we don't need to test that scenario.
