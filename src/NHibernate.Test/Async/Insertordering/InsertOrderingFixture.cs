...
namespace NHibernate.Test.Insertordering
{
	...
	public partial class InsertOrderingFixtureAsync : TestCase
	{
		...
		// Non-reg test case.
		[Test]
		public async System.Threading.Tasks.Task WithElementCollectionAsync()
		{
			using (ISession session = OpenSession())
			using (var trx = session.BeginTransaction())
			{
		...
		// Failing test case till NH-3931 is fixed.
		[Test]
		public async System.Threading.Tasks.Task WithJoinedTableInheritance_MultiLevelAsync()
		{
			using (ISession session = OpenSession())
			using (var trx = session.BeginTransaction())
			{
		...
		// Failing test case till NH-3931 is fixed.
		[Test]
		public async System.Threading.Tasks.Task WithSingleTableInheritanceAsync()
		{
			using (ISession session = OpenSession())
			using (var trx = session.BeginTransaction())
			{
		...
		// Non-reg test case
		[Test]
		public async System.Threading.Tasks.Task WithTablePerConcreteInheritanceAsync()
		{
			using (ISession session = OpenSession())
			using (var trx = session.BeginTransaction())
			{
