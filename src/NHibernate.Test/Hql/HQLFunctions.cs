...
namespace NHibernate.Test.Hql
{
	...
	{
		static readonly Hashtable notSupportedStandardFunction = new Hashtable();
		static HQLFunctions()
		{
			...
			notSupportedStandardFunction.Add("bit_length",
				new[] { typeof(MsSql2000Dialect), typeof(MsSql2005Dialect), typeof(MsSql2008Dialect), typeof(MsSql2012Dialect), typeof(Oracle8iDialect), typeof(Oracle9iDialect), typeof(Oracle10gDialect), typeof(SQLiteDialect) });
			notSupportedStandardFunction.Add("extract",
				new[] { typeof(MsSql2000Dialect), typeof(MsSql2005Dialect), typeof(MsSql2008Dialect), typeof(MsSql2012Dialect), typeof(SQLiteDialect) });
