...
namespace NHibernate.Test.ExceptionsTest
{
	...
	public class SQLExceptionConversionTest : TestCase
	{
		...
		protected override bool AppliesTo(ISessionFactoryImplementor factory)
		{
			...
			return !(driver is OracleDataClientDriver) && !(driver is OracleManagedDataClientDriver) && !(driver is OracleLiteDataClientDriver) && 
				!(driver is OdbcDriver) && !(driver is OleDbDriver) && !(driver is MicrosoftDataSqlClientDriver);
		}
