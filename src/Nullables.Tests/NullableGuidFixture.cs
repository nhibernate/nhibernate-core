...
namespace Nullables.Tests
{
	...
	public class NullableGuidFixture
	{
		...
		public void BasicTestGuid()
		{
			...
			Assert.IsTrue( v1.Equals( new Guid( "00000000-0000-0000-0000-000000000005" ) ) ); //implicit casting should make this result in true.
			Assert.IsTrue( v1.Value == new Guid( "00000000-0000-0000-0000-000000000005" ) );
			Assert.IsFalse( v1.Equals( NullableGuid.Default ) );
			Assert.IsTrue( v1.Equals( new NullableGuid( new Guid( "00000000-0000-0000-0000-000000000005" ) ) ) ); //should == a new instance with the same inner value.
