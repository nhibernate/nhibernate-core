    ...
    public class SysCache : ICache
    {
        ...
        private void Configure(IDictionary props)
        {
            ...
            else
            {
                ...
                if (props["regionPrefix"] != null)
                {
                    _regionPrefix = props["regionPrefix"].ToString();
        ...
        {
            return String.Concat(_cacheKeyPrefix, _regionPrefix, _region, ":", key.ToString(), "@", key.GetHashCode());
        }
