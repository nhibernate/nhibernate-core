...
namespace NHibernate.Tuple.Entity
{
    ...
    public class EntityEntityModeToTuplizerMapping : EntityModeToTuplizerMapping
    {
        ...
        public EntityEntityModeToTuplizerMapping(PersistentClass mappedEntity, EntityMetamodel em)
        {
            ...
            if (!userSuppliedTuplizerImpls.TryGetValue(EntityMode.Map, out dyntuplizerImpl))
            {
                dynamicTuplizer = new DynamicEntityTuplizer(em, mappedEntity);
            }
            else
            {
                dynamicTuplizer = BuildEntityTuplizer(dyntuplizerImpl, mappedEntity, em);
