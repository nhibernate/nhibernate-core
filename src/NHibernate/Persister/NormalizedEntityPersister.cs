...
namespace NHibernate.Persister 
{
	...
	public class NormalizedEntityPersister : AbstractEntityPersister 
	{
			...
			: base(model, factory) 
		{
			...
			System.Array.Reverse(subclassTableNameClosure, 0 , len);
			System.Array.Reverse(subclassTableKeyColumns, 0, len);
		...
		private void InitPropertyPaths(IMapping mapping) 
		{
			...
			tableNumberByPropertyPath[PathExpressionParser.EntityClass]= (int)0 ;
		}
		...
		private void InitPropertyPaths(string propertyName, IType propertyType, string[] columns, int table, IMapping mapping) 
		{
			if ( propertyName!=null ) 
			{
				...
				tableNumberByPropertyPath[propertyName] = (int)table ;
			}
