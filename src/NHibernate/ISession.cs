...
namespace NHibernate
{
	...
	/// </remarks>
	public interface ISession : ISharedSessionContract
	{
		...
		/// <remarks>
		/// You should not use this method to determine if an instance exists (use a query or
		/// <see cref="ISharedSessionContract.Get{T}(object)" /> instead). Use this only to retrieve an instance that you
		...
		/// <returns> The persistent instance or proxy </returns>
		/// <remarks>
		/// You should not use this method to determine if an instance exists (use <see cref="ISharedSessionContract.Get(string,object)"/>
		...
		/// <summary>
		/// Either <see cref="Save(String,Object)"/> or <see cref="ISharedSessionContract.Update(String,Object)"/>
		...
		/// <seealso cref="ISharedSessionContract.Update(String,Object)"/>
		/// <remarks>
		/// This operation cascades to associated instances if the association is mapped
