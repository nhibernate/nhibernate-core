...
namespace NHibernate.Cache
{
	...
	public partial interface ICacheConcurrencyStrategy
	{
		...
		Task<object> GetAsync(CacheKey key, long txTimestamp);
		...
		/// <exception cref="CacheException"></exception>
		Task<bool> PutAsync(CacheKey key, object value, long txTimestamp, object version, IComparer versionComparer, bool minimalPut);
		...
		Task<ISoftLock> LockAsync(CacheKey key, object version);
		...
		/// <remarks>This method is used by "synchronous" concurrency strategies.</remarks>
		Task<bool> UpdateAsync(CacheKey key, object value, object currentVersion, object previousVersion);
		...
		/// <exception cref="CacheException"></exception>
		/// <remarks>This method is used by "asynchronous" concurrency strategies.</remarks>
		Task ReleaseAsync(CacheKey key, ISoftLock @lock);
		...
		/// <remarks>This method is used by "asynchronous" concurrency strategies.</remarks>
		Task<bool> AfterUpdateAsync(CacheKey key, object value, object version, ISoftLock @lock);
		...
		/// <param name="version"></param>
		/// <remarks>This method is used by "asynchronous" concurrency strategies.</remarks>
		Task<bool> AfterInsertAsync(CacheKey key, object value, object version);
