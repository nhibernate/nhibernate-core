    ...
    public abstract class Dialect
    {
        ...
        protected Dialect()
        {
            ...
            RegisterFunction("current_timestamp",
                             new NoArgSQLFunction("current_timestamp", NHibernateUtil.DateTime, true));
                ...
                return
                    (Dialect)
                        Environment.BytecodeProvider.ObjectsFactory.CreateInstance(
                            ReflectHelper.ClassForName(dialectName));
            }
            catch (Exception e)
            {
        ...
        public virtual string GetTypeName(SqlType sqlType)
        {
            ...
            {
                string resultWithLength = _typeNames.Get(sqlType.DbType, sqlType.Length, sqlType.Precision,
                                                         sqlType.Scale);
        ...
        public virtual string GetTypeName(SqlType sqlType, int length, int precision, int scale)
        {
            ...
            if (result == null)
            {
                throw new HibernateException(string.Format("No type mapping for SqlType {0} of length {1}", sqlType,
                                                           length));
            }
            return result;
        }
        ...
        /// </remarks>
        public virtual SqlString ApplyLocksToSql(SqlString sql, IDictionary<string, LockMode> aliasedLockModes,
        ...
        /// <param name="name">The name.</param>
        /// <returns></returns>
        public virtual string GetIfNotExistsCreateConstraint(string constraintName, string tableName)
        {
            return "";
        }
        ...
        /// <param name="tableName"></param>
        /// <returns></returns>
        public virtual string GetIfExistsDropConstraint(string constraintName, string tableName)
        {
            return "";
        }
        ...
        /// <param name="constraintName">The name.</param>
        /// <returns></returns>
        public virtual string GetIfExistsDropConstraintEnd(string constraintName, string tableName)
        {
            return "";
        }
        ...
        public virtual SqlString AddIdentifierOutParameterToInsert(SqlString insertString, string identifierColumnName,
        ...
        internal static void ExtractColumnOrAliasNames(SqlString select, out List<SqlString> columnsOrAliases,
                                                       ...
                                                       out Dictionary<SqlString, SqlString> columnToAlias)
        {
            ...
            while (index < tokens.Count)
            {
                ...
                bool isFunctionCallOrQuotedString = token.IndexOfCaseInsensitive("'") >= 0 ||
                                                    token.IndexOfCaseInsensitive("(") >= 0;
                        ...
                        case TokenizerState.Quoted:
                            if (escapeQuote)
                            {
                                ...
                                // handle escaping of ' by using '' or \'
                                     ...
                                     (ch == quoteType && i + 1 < originalString.Length &&
                                      originalString[i + 1] == quoteType))
                            {
                                escapeQuote = true;
                                tokenLength += 1;
                            }
        ...
        /// <returns></returns>
        public SqlString GetLimitString(SqlString queryString, int? offset, int? limit, Parameter offsetParameter,
                                        Parameter limitParameter)
        {
            ...
            SqlString o =
                SupportsVariableLimit && offsetParameter != null
                    ? new SqlString(offsetParameter)
                    : offset.HasValue
                        ? new SqlString(offset.ToString())
                        : null;

            SqlString l =
                SupportsVariableLimit && limitParameter != null
                    ? new SqlString(limitParameter)
                    : limit.HasValue
                        ? new SqlString(limit.ToString())
                        : null;
        ...
        /// </p>
        /// </remarks>
        internal virtual string Quote(string name)
        {
        ...
        /// <summary> Does this dialect support adding Unique constraints via create and alter table ?</summary>
        public virtual bool SupportsUniqueConstraintInAlterTable
        {
            get { return true; }
        }

        public virtual string GetAddUniqueConstraintString(string constraintName)
        {
            return " add constraint " + constraintName + " unique ";
        }

        public virtual bool RequiresClusteredPrimaryKey
        {
            get { return false; }
        }
        ...
        public virtual string AlterColumnString
        {
            get
            {
                if (!SupportsAlterColumn)
                    throw new NotImplementedException(GetType().FullName + " Doesnt support altering columns");
                return "alter column";
            }
        }
    }
