...
namespace NHibernate.Dialect
{
	...
	public abstract class Dialect
	{
	    ...
	    public virtual string AlterColumnString
	    {
	        get
	        {
	            if(!SupportsAlterColumn) throw new NotImplementedException( GetType().FullName+" Doesnt support altering columns");
	            return "alter column";
	        }
	    }


	    public virtual bool SupportsRenameColumn
	    {
	        get { return false; }
	    }

	    public virtual string GetRenameColumnString(string tableName, string oldColumnName, string newColumnName)
	    {
	        throw new NotImplementedException(GetType().FullName +" Does not support renaming columns");
	    }

      public virtual string GetRenameTableString(string oldTableName, string newTableName)
	    {
	        throw new NotImplementedException(GetType().FullName +" Does not support renaming tables");
	    }
	 }
}