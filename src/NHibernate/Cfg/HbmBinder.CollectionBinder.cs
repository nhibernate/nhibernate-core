...
namespace NHibernate.Cfg
{
	...
	{
		protected static class CollectionBinder
		{
			private delegate Mapping.Collection CreateCollectionCommand(XmlNode node, string className,
				string path, PersistentClass owner, System.Type containingType, Mappings mappings);

			private static readonly IDictionary<string, CreateCollectionCommand> createCollectionCommands =
			...
			public static bool CanCreate(string xmlTagName)
			{
				return createCollectionCommands.ContainsKey(xmlTagName);
			}

			public static Mapping.Collection Create(string xmlTagName, XmlNode node, string className,
				string path, PersistentClass owner, System.Type containingType, Mappings mappings)
			{
				CreateCollectionCommand command = createCollectionCommands[xmlTagName];
				return command(node, className, path, owner, containingType, mappings);
			}

			private static Mapping.Collection CreateMap(XmlNode node, string prefix, string path,
				PersistentClass owner, System.Type containingType, Mappings mappings)
			{
			...
			private static Mapping.Collection CreateSet(XmlNode node, string prefix, string path,
				PersistentClass owner, System.Type containingType, Mappings mappings)
			{
			...
			private static Mapping.Collection CreateList(XmlNode node, string prefix, string path,
				PersistentClass owner, System.Type containingType, Mappings mappings)
			{
			...
			private static Mapping.Collection CreateBag(XmlNode node, string prefix, string path,
				PersistentClass owner, System.Type containingType, Mappings mappings)
			{
			...
			private static Mapping.Collection CreateIdentifierBag(XmlNode node, string prefix, string path,
				PersistentClass owner, System.Type containingType, Mappings mappings)
			{
			...
			private static Mapping.Collection CreateArray(XmlNode node, string prefix, string path,
				PersistentClass owner, System.Type containingType, Mappings mappings)
			{
			...
			private static Mapping.Collection CreatePrimitiveArray(XmlNode node, string prefix, string path,
				PersistentClass owner, System.Type containingType, Mappings mappings)
			{
			...
			/// </remarks>
			private static void BindCollection(XmlNode node, Mapping.Collection model, string className,
				string path, System.Type containingType, Mappings mappings)
			{
				// ROLENAME
			...
			private static void AddCollectionSecondPass(XmlNode node, Mapping.Collection model,
				Mappings mappings)
			{
				mappings.AddSecondPass(delegate(IDictionary<System.Type, PersistentClass> persistentClasses)
					{
			...
			private static void BindManyToManySubelements(Mapping.Collection collection,
				XmlNode manyToManyNode, Mappings model)
			{
				// Bind the where
