...
//		IList whereColumnNames = new ArrayList(); // name of the column
//		IList whereColumnValues = new ArrayList(); // string or a Parameter

		// TODO: remove this once it is all converted to SqlStrings
		IList whereFragments = new ArrayList(); // might change this to a list of fragements - maybe not
		...
		public SqlString ToSqlString(){
			...
			sqlBuilder.Add("SELECT ").Add(selectClause)
				.Add(" FROM ").Add(fromClause)
