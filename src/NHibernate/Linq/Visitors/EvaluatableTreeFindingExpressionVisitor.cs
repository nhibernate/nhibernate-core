...
{
	/// <summary>
	/// Unsealed class from https://github.com/re-motion/Relinq. Minimal modifications were necessary to modify treatment
	/// of parameters in expressions and consider them as evaluatable if they derive value from evaluatable expressions.
	/// 
