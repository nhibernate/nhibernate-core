...
namespace NHibernate.Linq.NestedSelects
{
	internal class NestedSelectDetector : RelinqExpressionVisitor
	{
		...
		public ICollection<Expression> Expressions => _expressions;

		public bool HasSubqueries => Expressions.Count > 0;
		...
		private bool IsMappedCollection(MemberInfo memberInfo)
		{
			...
			return _sessionFactory.GetCollectionMetadata(collectionRole) != null;
		}
