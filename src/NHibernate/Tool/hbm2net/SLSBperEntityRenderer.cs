...
namespace NHibernate.tool.hbm2java
{
	...
	public class SLSBperEntityRenderer:AbstractRenderer
	{
		...
		/* (non-Javadoc)
		* @see NHibernate.tool.hbm2java.Renderer#render(java.lang.String, java.lang.String, NHibernate.tool.hbm2java.ClassMapping, java.util.Map, java.io.PrintWriter)
		*/
