...
", classMapping.ClassName);
		...
		private void  doSupportMethods(int fieldTypes, string vetoSupport, string changeSupport, System.IO.StringWriter writer)
		{
		...
		/// <param name="writer">
		/// </param>
		private void  doSupports(int fieldTypes, ClassMapping classMapping, string vetoSupport, string changeSupport, System.IO.StringWriter writer)
		{
			if ((fieldTypes & CONSTRAINT) == CONSTRAINT)
			{
		...
		public virtual void  doConstructors(string savedToClass, ClassMapping classMapping, System.Collections.IDictionary class2classmap, System.IO.StringWriter writer)
		{
			// full constructor
		...
		public virtual void  doEqualsAndHashCode(string savedToClass, ClassMapping classMapping, System.IO.StringWriter writer)
		{
		...
		public virtual int doFieldAccessors(ClassMapping classMapping, System.Collections.IDictionary class2classmap, System.IO.StringWriter writer, string vetoSupport, string changeSupport)
		{
		...
		private int doFields(ClassMapping classMapping, System.Collections.IDictionary class2classmap, System.IO.StringWriter writer, string vetoSupport, string changeSupport, int fieldTypes, SupportClass.ListCollectionSupport fieldz)
		{
			// field accessors
		...
		private string getFieldAsObject(bool prependThis, FieldProperty field)
		{
			...
			{
				string typeName = (System.String) primitiveToObject[type.Name];
