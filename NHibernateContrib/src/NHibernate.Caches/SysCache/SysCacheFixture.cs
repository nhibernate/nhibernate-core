...
namespace NHibernate.Caches.SysCache.Tests
{
	...
	public class SysCacheFixture
	{
		...
		public void FixtureSetup()
		{
			...
			props = new Hashtable();
			props.Add( "relativeExpiration", 120 );
		...
		public void TestHistoricStaticExpiration()
		{
			Hashtable h = new Hashtable();
		...
		public void TestBadStaticExpiration()
		{
			Hashtable h = new Hashtable();
		...
		public void TestObjectExpiration()
		{
			...
			localProps.Add( "relativeExpiration", expirySeconds );
