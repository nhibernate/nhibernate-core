...
namespace NHibernate.Mapping.Attributes.Test.DomainModel
{
 ...
 [NHMA.HibernateMapping(-1, DefaultCascade=Mapping.Attributes.CascadeStyle.None, Schema="Schema", DefaultAccessType=typeof(int), AutoImport=true, Namespace="NH", Assembly="NH")]
...
/*
	...
	public class Stuff
	{
		...
		[NHMA.Set(-2, Inverse=true, Cascade=NHMA.CascadeStyle.All, OuterJoin=NHMA.OuterJoinStrategy.True, AccessType=typeof(bool), Where="1=1", PersisterType=typeof(Foo), SortType=typeof(bool))]
			[NHMA.Key(-1, Column="col")]
